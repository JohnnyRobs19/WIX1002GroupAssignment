...
public class FXMLController implements Initializable {
    ...
    private static final String CSV_FILE_PATH = "src//backups//employee.csv";
...
//    }
    ...
    @FXML
    private void userSignUp(ActionEvent event) throws CsvException {
    ...
    private int getLastEmployeeId() throws IOException, CsvException {
    ...
    private boolean isEmployeeNameDuplicate(String enteredEmployeeName) throws IOException, CsvException {
        try (CSVReader reader = new CSVReader(new FileReader(CSV_FILE_PATH))) {
            List<String[]> lines = reader.readAll();
